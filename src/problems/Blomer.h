...
inline STN<Field> generate_problem() {
  ...
  auto* state9 = stn->add(OutputState{0, 148});      // perhaps we could make these 
  auto* state10 = stn->add(OutputState{0, 1000-7});  // numbers more meaningful?
