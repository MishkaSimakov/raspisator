...
class STN {
  ...
  std::deque<State<Field>> states_;

  enum class ConnectionType { PRODUCER, CONSUMER };

  auto get_connections_of(const State<Field>& state,
